...
class Review(TypedDict):
     ...
     summary : Annotated[str,"The Summary of the given Topic"]
     sentiment : Annotated[Literal["positive","negetive"],"Give the Sentiment of the Topic"]
     pros : Annotated[Optional[list[str]],"note down the Pros of the topic character"]
     cons : Annotated[Optional[list[str]],"note down the Cons of the topic character"]
     name : Annotated[Optional[str],"Write the Author of the Post"]
